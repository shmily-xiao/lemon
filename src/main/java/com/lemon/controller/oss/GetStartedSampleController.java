 ...
 */
public class GetStartedSampleController {

    private static String endpoint = "http://lemon-xiao.oss-cn-shanghai.aliyuncs.com";
    private static String accessKeyId = "LTAI42vbp2yO2On1";
    private static String accessKeySecret = "0wGa34WCCpOmOxS3tLtVBkQW6r2IU7";
    private static String bucketName = "lemon-xiao";
